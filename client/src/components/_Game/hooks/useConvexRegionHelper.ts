...
export function useConvexRegionHelper() {
  const createConvexRegionHelper = useCallback(
    (navMesh: NavMesh): THREE.Mesh => {
      ...
      for (let region of regions) {
        ...
        color.setHex(0x4f504f * Math.random())
  ...
  return { createConvexRegionHelper }
}
